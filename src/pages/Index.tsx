    ...
    <div className="min-h-screen bg-background text-foreground">
      <nav className="fixed top-0 w-full z-50 bg-card/80 backdrop-blur-lg border-b border-border">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Button
            size="sm"
            className="bg-gaming-orange hover:bg-gaming-orange/90"
          >
            Играть
          </Button>
        </div>
          ...
          <div className="relative container mx-auto px-4 text-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl md:text-2xl mb-8 text-muted-foreground max-w-2xl mx-auto">
                Лучший ролевой сервер с уникальными возможностями и
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-12">
                ...
                <Button
                  size="lg"
                  className="bg-gaming-orange hover:bg-gaming-orange/90 text-lg px-8"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  <Card
                    key={index}
                    className="bg-card/30 border-border/50 hover:scale-105 transition-transform"
                  >
                ...
                {[
                  {
                    ...
                    title: "Общие правила",
                    content:
                      "Уважайте других игроков, не используйте читы, играйте честно и получайте удовольствие от игры.",
                  },
                  {
                    id: "roleplay",
                    title: "Ролевая игра",
                    content:
                      "Соблюдайте ролевую составляющую, не нарушайте атмосферу игры, используйте адекватные имена персонажей.",
                  },
                  {
                    id: "punishment",
                    title: "Наказания",
                    content:
                      "За нарушения правил предусмотрены предупреждения, муты, кики и баны различной длительности.",
                  },
                ].map((rule) => (
                  <AccordionItem
                    key={rule.id}
              ...
              <Card className="relative overflow-hidden bg-gradient-to-b from-card/80 to-card border-border/50 shadow-lg">
                ...
                <CardHeader className="text-center relative z-10 pb-6">
                  ...
                  <p className="text-muted-foreground">
                    Пополните игровой баланс на любую сумму
                  </p>
                </CardHeader>
                ...
                <CardContent className="relative z-10 space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      Баланс будет зачислен на этот аккаунт
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gaming-cyan font-bold text-xl">
                        ₽
                      </span>
                    </div>
                    <p className="text-xs text-muted-foreground mt-2">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <button
                          key={index}
                          className={`p-4 border rounded-lg hover:scale-105 transition-all flex flex-col items-center gap-2 ${
                            method.popular
                        ...
                        >
                          ...
                          {method.popular && (
                            <Badge className="bg-gaming-orange text-[10px] px-2">
                              Популярный
                            </Badge>
                          )}
                        </button>
                  ...
                  <div className="bg-gaming-blue/10 border border-gaming-blue/30 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        {
                          amount: "1000₽+",
                          bonus: "+15% к балансу + VIP статус на день",
                        },
                      ].map((bonus, i) => (
                        <div
                          key={i}
                        ...
                        >
                          ...
                          <span className="text-sm text-gaming-orange font-bold">
                            {bonus.bonus}
                          </span>
                        </div>
                      ))}
              ...
              <Card className="relative overflow-hidden bg-gradient-to-b from-card/80 to-card border-border/50 shadow-lg">
                ...
                <CardHeader className="text-center relative z-10 pb-6">
                  <div className="w-20 h-20 mx-auto rounded-full bg-gaming-blue/20 border-2 border-gaming-blue/50 flex items-center justify-center mb-6">
                    ...
                    >
                      <path
                        d="M18 3.6C9.4 3.6 2.4 9.7 2.4 17.1C2.4 21.3 4.5 25 7.9 27.4V32.4L12.7 29.8C14.4 30.2 16.2 30.4 18 30.4C26.6 30.4 33.6 24.3 33.6 16.9C33.6 9.7 26.6 3.6 18 3.6Z"
                        fill="currentColor"
                      />
                      <path
                        d="M12 14.4H24V16.8H12V14.4ZM12 18H21.6V20.4H12V18Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                  ...
                  <p className="text-muted-foreground">
                    Присоединяйтесь к нашему сообществу в ВК для общения и
                    новостей
                  </p>
                </CardHeader>
                ...
                <CardContent className="relative z-10 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gaming-cyan/10 border border-gaming-cyan/30 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-gaming-cyan mb-1">
                        2,547
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Участников
                    ...
                    <div className="bg-gaming-orange/10 border border-gaming-orange/30 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-gaming-orange mb-1">
                        512
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Постов
                    ...
                    <div className="bg-gaming-blue/10 border border-gaming-blue/30 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-gaming-blue mb-1">
                        98
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Обсуждений
                      ...
                      {[
                        {
                          ...
                          desc: "Первыми узнавайте об обновлениях",
                          icon: "Newspaper",
                        },
                        {
                          name: "Общение с игроками",
                          desc: "Находите единомышленников",
                          icon: "Users",
                        },
                        {
                          name: "Поддержка и помощь",
                          desc: "Быстрые ответы от администрации",
                          icon: "HelpCircle",
                        },
                        {
                          name: "Конкурсы и розыгрыши",
                          desc: "Участвуйте и выигрывайте призы",
                          icon: "Gift",
                        },
                      ].map((feature, index) => (
                        <div
                          key={index}
                          className="p-4 bg-[#0077FF]/10 border border-[#0077FF]/30 rounded-lg hover:bg-[#0077FF]/20 transition-colors"
                        >
                          <div className="flex items-start gap-3">
                            <Icon
                              name={feature.icon as any}
                              size={20}
                              className="text-[#0077FF] mt-0.5"
                            />
                            <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {[
                        {
                          title: "📢 Масштабное обновление уже скоро!",
                        ...
                        {
                          title: "💡 Советы для новых игроков",
                          author: "Помощник",
                          time: "12 часов назад",
                        },
                      ].map((post, index) => (
                  ...
                  <div className="text-center pt-4">
                    <Button
                      onClick={() =>
                        window.open(
                          "https://vk.com/auroragameproject",
                          "_blank",
                        )
                      }
                    ...
                    >
                      <span className="relative z-10 flex items-center justify-center gap-2">
                        ...
                        >
                          <path
                            d="M10 2C5.6 2 2 5.6 2 10C2 12.2 2.8 14.2 4.2 15.7L17.8 15.7C18.5 14.4 18.9 12.9 18.9 11.3C18.9 6.9 15.3 3.3 10.9 3.3H10V2Z"
                            fill="currentColor"
                          />
                        </svg>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  preview:
                    "Обновленные правила для улучшения игрового процесса",
                  tag: "Важное",
                },
              ].map((news, index) => (
                <Card
